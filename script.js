...
/* -------------------------------------------------------------- */
/* 20b. GESTION DE L'IMAGE DINOSAURE — API Wikipedia (même        */
/* mécanisme que les avatars, qui fonctionne déjà parfaitement)  */
/* CORS OK depuis navigateur, images = illustrations artistiques  */
/* en tête de page Wikipedia (infobox), pas des squelettes.       */
/* -------------------------------------------------------------- */

// Correspondance code dino → titre exact de la page Wikipedia EN
// Ces noms ont été choisis car leur infobox Wikipedia affiche
// une illustration artistique colorée (animal vivant) en priorité.
const DINO_WIKI_MAP = {
    trex:               'Tyrannosaurus',
...
// Cache séparé pour les images dino (ne pas polluer avatarImgCache)
const _dinoImgCache = {};

async function getDinoImageUrl(code) {
    const wikiTitle = DINO_WIKI_MAP[code];
    if (!wikiTitle) return null;
    if (_dinoImgCache[wikiTitle] !== undefined) return _dinoImgCache[wikiTitle];
    try {
        ...
        const pages = data.query.pages;
        const page  = Object.values(pages)[0];
        const src   = (page.thumbnail && page.thumbnail.source) ? page.thumbnail.source : null;
        _dinoImgCache[wikiTitle] = src;
        return src;
    } catch (e) {
        _dinoImgCache[wikiTitle] = null;
        return null;
    }
}
...
const DINO_IMG = {
    trex:               'Images/Tyrannosaurus Rex.png',
    triceratops:        'Images/Triceratops.png',
    velociraptor:       'Images/Velociraptor.png',
    raptor:             'Images/Velociraptor.png',
    stegosaurus:        'Images/Stegosaurus.png',
    stegosaure:         'Images/Stegosaurus.png',
    spinosaurus:        'Images/Spinosaurus.png',
    dragon:             'Images/Spinosaurus.png',
    ankylosaurus:       'Images/Ankylosaurus.png',
    ankylo:             'Images/Ankylosaurus.png',
    brachiosaurus:      'Images/Brachiosaurus.png',
    diplodocus:         'Images/Diplodocus.png',
    allosaurus:         'Images/Allosaurus.png',
    parasaurolophus:    'Images/Parasaurolophus.png',
    para:               'Images/Parasaurolophus.png',
    iguanodon:          'Images/Iguanodon.png',
    iguanodon2:         'Images/Iguanodon.png',
    carnotaurus:        'Images/Carnotaurus.png',
    abelisaurus:        'Images/Carnotaurus.png',
    giganotosaurus:     'Images/Giganotosaurus.png',
    apatosaurus:        'Images/Apatosaurus.png',
    pachycephalosaurus: 'Images/Pachycephalosaurus.png',
    pachy:              'Images/Pachycephalosaurus.png',
    dilophosaurus:      'Images/Dilophosaurus.png',
    compsognathus:      'Images/Compsognathus.png',
    archaeopteryx:      'Images/Archaeopteryx.png',
    therizinosaurus:    'Images/Therizinosaurus.png',
    oviraptor:          'Images/Oviraptor.png',
    argentinosaurus:    'Images/Argentinosaurus.png',
    patagotitan:        'Images/Argentinosaurus.png',
    titanosaurus:       'Images/Argentinosaurus.png',
    baryonyx:           'Images/Baryonyx.png',
    suchomimus:         'Images/Baryonyx.png',
    deinocheirus:       'Images/Deinocheirus.png',
    gallimimus:         'Images/Gallimimus.png',
    ornithomimus:       'Images/Gallimimus.png',
    pteranodon:         'Images/Pteranodon.png',
    pteradon:           'Images/Pteranodon.png',
    plesiosaurus:       'Images/Plesiosaurus.png',
    plesio:             'Images/Plesiosaurus.png',
    deinonychus:        'Images/Deinonychus.png',
    ichthyosaurus:      'Images/Ichthyosaurus.png',
    protoceratops:      'Images/Protoceratops.png',
    maiasaura:          'Images/Maiasaura.png',
    ceratosaurus:       'Images/Ceratosaurus.png',
    albertosaurus:      'Images/Albertosaurus.png',
    styracosaurus:      'Images/Styracosaurus.png',
    mosasaurus:         'Images/Plesiosaurus.png',
    mosasaur:           'Images/Plesiosaurus.png',
};
...
function afficherQuestion() {
    ...
    if (currentDomainKey === 'dinosaures' && q.isDinoImg && q.code && q.code.trim() !== "") {
        hideFlagImage();
        showDinoImage(q.code.trim()); // API Wikipedia — même mécanisme que les avatars
